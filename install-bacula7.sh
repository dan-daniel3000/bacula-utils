...
echo -e "###############################################################"
echo -e "# Passos para Instalação do Bacula 7 via Compilação no Debian #"
echo -e "# PostgreSQL                                                  #"
...
#-----------------------------------------------------------------------------------#
# >>> Baixando e compilando e instalando o fonte Bacula Server 7 <<<                #
#-----------------------------------------------------------------------------------#
echo -e "Baixando, compilando, e instalando o fonte Bacula Server 7..."
echo -e
...
cd /usr/src
# Utilizando wget:
wget --no-check-certificate https://downloads.sourceforge.net/project/bacula/bacula/7.4.7/bacula-7.4.7.tar.gz
tar xvzf bacula*
cd /usr/src/bacula*
...
# Efetuando ajuste de versão do catálogo Webacula com a versão da base de dados Postgres (versão 15) atual no arquivo de configuração /var/www/webacula/html/index.php:
sed -i -e "s/define('BACULA_VERSION', 14); \/\/ Bacula Catalog version/define('BACULA_VERSION', 15); \/\/ Bacula Catalog version/g" /var/www/webacula/html/index.php
